<template>
    ...
    <PageBase title="Időpontok" width="12">

        <v-row slot="content" width="12" class="fill-height">
        ...
        methods: {
            ...
            editInterval(event) {
                ...
                this.events.push({
                    ...
                    start: this.formatDate(new Date(event.date)),
                    end: this.formatDate(new Date(event.date).getTime() + 3600),
